...
This tool allows the user to visualize and annotate 3D representations of objects that have been scanned into one or more .tif files. The tool allows for the annotation
...
2.) Docker Desktop for Windows <br/>
  - enabled WSL (Windows Subsystem for Linux) Integration for Ubuntu in Docker Desktop <br/>
